...
//    }
    ...
    public static Rect getBox(View view)
    {
...
//
    ...
    public static Bitmap getCroppedBitmap(String imagePath, float previewWidth, float previewHeight, Rect box)
    {
        BitmapFactory.Options options = new BitmapFactory.Options();
        ...
        float widthScalingFactor = imageWidth / previewWidth;
        float heightScalingFactor = imageHeight / previewHeight;

        int requiredImageWidth = box.width();
        int requiredImageHeight = box.height();
        int requiredImageX = box.left;
        int requiredImageY = box.top;

        int croppedImageWidth = Math.round(requiredImageWidth * widthScalingFactor);
        int croppedImageHeight = Math.round(requiredImageHeight * heightScalingFactor);
        int croppedImageX = Math.round(requiredImageX * widthScalingFactor);
        int croppedImageY = Math.round(requiredImageY * heightScalingFactor);
        Bitmap croppedBmp = Bitmap.createBitmap(bmp, croppedImageX, croppedImageY, croppedImageWidth, croppedImageHeight);
        return croppedBmp;
